...
class AutoLearner:
    ...
    def __init__(self,
                 ...
                 load_saved_runtime_predictors=True, save_fitted_runtime_predictors=False, random_state=0, **stacking_hyperparams):
...
#             self.pipeline_settings = pickle.load(handle)
        ...
        self.runtime_predictor = convex_opt.initialize_runtime_predictor(
            runtime_matrix=self.runtime_matrix, runtimes_index=self.training_index, model_name=self.runtime_predictor_algorithm, load=load_saved_runtime_predictors, save=save_fitted_runtime_predictors, verbose=self.verbose)
